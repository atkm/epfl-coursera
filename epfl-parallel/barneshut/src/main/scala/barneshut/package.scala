...
package object barneshut {
  ...
  // Note: the top left corner has (x,y)=(0,0).
  // Positive directions are E and S.
  sealed abstract class Quad {
    // the coords of the center of mass of bodies in the cell
    def massX: Float

    def massY: Float

    // the total mass of bodies in the cell
    def mass: Float

    // the coords of the center of the cell
    def centerX: Float

    def centerY: Float

    // the length of each side of the cell
    def size: Float

    // the total number of bodies in the cell
    def total: Int

    // creates a new quadtree which additionally contains b, and covers
  ...
  // Note: this wasn't a case class in the original file
